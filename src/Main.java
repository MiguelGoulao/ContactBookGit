...
public class Main {
    ...
    public static final String CONTACT_GIVEN_NUMBER = "GN";
    ...
    public static final String REPEATED_NUMBER = "There are contacts that share phone numbers.";
    public static final String NO_REPEATED_NUMBER = "All contacts have different phone numbers.";
    ...
    private static void phoneSameNumber(ContactBook cBook) {
        if (cBook.equalPhone())
            ...
            System.out.println(NO_REPEATED_NUMBER);
    }
}
