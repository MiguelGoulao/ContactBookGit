...
public class Main {
    ...
    public static final String DUPLICATE_PHONES = "EP";
    ...
    public static final String CONTACTS_WITH_SAME_PHONE = "There are contacts that share phone numbers.";
    public static final String ALL_CONTACTS_DIFFERENT_PHONE = "All contacts have different phone numbers";
    ...
    private static void duplicatePhones(ContactBook cBook) {
        if (cBook.hasDuplicatePhones()) {
            System.out.println(CONTACTS_WITH_SAME_PHONE);
        } else {
            System.out.println(ALL_CONTACTS_DIFFERENT_PHONE);
        }
    }
}
